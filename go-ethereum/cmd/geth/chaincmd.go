...
import (
	...
	"github.com/haxicode/go-ethereum/cmd/utils"
	"github.com/haxicode/go-ethereum/common"
	"github.com/haxicode/go-ethereum/console"
...
The export-preimages command export hash preimages to an RLP encoded stream`,
	...
	copydbCommand = cli.Command{
		...
		Flags: []cli.Flag{
			...
			utils.CacheFlag,
			utils.SyncModeFlag,
			utils.FakePoWFlag, //模仿Pow共识算法
			utils.TestnetFlag, //测试网络
			utils.RinkebyFlag, //Rinkeby测试网络
		},
		Category: "BLOCKCHAIN COMMANDS",
		Description: `
...
func initGenesis(ctx *cli.Context) error {
	...
	log.Info("initGenesis>>>>>", "genesis struct", genesis.Config.Dpos.Validators[0].Hex())
